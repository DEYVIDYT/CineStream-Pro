...
import { PlayIcon, PauseIcon, VolumeHighIcon, VolumeMediumIcon, VolumeMutedIcon, FullscreenIcon, ExitFullscreenIcon, SpinnerIcon, PipIcon, Forward10Icon, Backward10Icon } from './icons';
...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ src }) => {
  ...
  }, [isSeeking]); // Add isSeeking to deps
  ...
  return (
    <div ref={containerRef} className="relative w-full aspect-video bg-black rounded-lg overflow-hidden shadow-2xl shadow-cyan-500/10 group/container">
      {!isLive && (
        <>
